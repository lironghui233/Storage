...
#define DROP_SAMPLE_TABLE "DROP TABLE IF EXISTS utf8mb4_tbl" /* if EXISTS 好处 是如果表不存在,执行不会报错 */
#define CREATE_SAMPLE_TABLE "CREATE TABLE utf8mb4_tbl ( \
                                utf8mb4_id INT UNSIGNED AUTO_INCREMENT, \
                                utf8mb4_title VARCHAR(100) NOT NULL,    \
                                PRIMARY KEY (utf8mb4_id)            \
                            )ENGINE=InnoDB DEFAULT CHARSET=utf8mb4"
#define INSERT_SAMPLE_TABLE "INSERT INTO utf8mb4_tbl ( utf8mb4_title ) VALUES ('廖庆富𤋮熙darren老师')"
#define SELECT_SAMPLE_TABLE "SELECT * FROM utf8mb4_tbl"
#define DBNAME "unicode"
#define CHARSET "utf8mb4"

// 先创建对应的数据库： CREATE DATABASE unicode;
// gcc -o utf8mb4_tbl utf8mb4_tbl.c -lmysqlclient -I/usr/include/mysql -L/usr/lib64/mysql/
int main()
{
    MYSQL *mysql;
    MYSQL_RES *res_ptr;
    ...
    // 连接数据库
    mysql = mysql_real_connect(mysql, "localhost", "root", "123456", DBNAME, 0, NULL, 0);
