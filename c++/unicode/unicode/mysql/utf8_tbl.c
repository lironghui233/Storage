...
#define INSERT_SAMPLE_TABLE "INSERT INTO utf8_tbl ( utf8_title ) VALUES ('廖庆富𤋮熙darren老师')"
// #define INSERT_SAMPLE_TABLE "INSERT INTO utf8_tbl ( utf8_title ) VALUES ('廖庆富darren老师')"
#define SELECT_SAMPLE_TABLE "SELECT * FROM utf8_tbl"
#define DBNAME "unicode"
#define CHARSET "utf8"

// （1）先创建对应的数据库： CREATE DATABASE unicode;
// （2）gcc -o utf8_tbl utf8_tbl.c -lmysqlclient -I/usr/include/mysql -L/usr/lib64/mysql/
int main()
{
    MYSQL *mysql;
    MYSQL_RES *res_ptr;
